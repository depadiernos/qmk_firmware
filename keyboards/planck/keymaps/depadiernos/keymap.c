...
[_ADJUST] = {
  {KC_PSCR, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RESET},
  ...
  {BACKLIT, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY}
}
