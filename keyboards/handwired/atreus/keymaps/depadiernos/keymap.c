...
#define SPCRS LT(RAISE, KC_SPC)
#define BSPCLW LT(LOWER, KC_BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTRL, KC_LALT, KC_LGUI, KC_ESC,  BSPCLW,  KC_LSFT, SFTENT,  SPCRS,   KC_MINS, KC_EQL,  KC_QUOT, KC_BSLS
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, _______, _______, KC_DEL,  _______, _______, _______, _______, _______, KC_GRV,  KC_LBRC,  KC_RBRC
  ),
  ...
  [_ADJUST] = LAYOUT(
    ...
    _______, _______, _______, _______, _______,                   _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,
